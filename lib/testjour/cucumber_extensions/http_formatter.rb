...
module Testjour
  class Visitor
    ...
    def visit_features(features)
      Testjour.logger.debug "visit_features..."
      features.accept(self)
      Testjour.logger.debug "visit_features done"
    end

    def visit_feature(feature)
      Testjour.logger.debug "visit_feature..."
      feature.accept(self)
      Testjour.logger.debug "visit_feature done"
    end

    def visit_comment(comment)
      Testjour.logger.debug "visit_comment"
      comment.accept(self)
      Testjour.logger.debug "visit_comment done"
    end
    ...
    def visit_tags(tags)
      Testjour.logger.debug "visit_tags"
      tags.accept(self)
      Testjour.logger.debug "visit_tags done"
    end
    ...
    def visit_background(background)
      Testjour.logger.debug "visit_background"
      background.accept(self)
      Testjour.logger.debug "visit_background done"
    end
    ...
    def visit_examples(examples)
      Testjour.logger.debug "visit_examples"
      examples.accept(self)
      Testjour.logger.debug "visit_examples done"
    end
    ...
    def visit_outline_table(outline_table)
      Testjour.logger.debug "visit_outline_table"
      outline_table.accept(self)
      Testjour.logger.debug "visit_outline_table done"
    end
    ...
    def visit_steps(steps)
      Testjour.logger.debug "visit_steps..."
      steps.accept(self)
      Testjour.logger.debug "visit_steps done"
    end

    def visit_step(step)
      Testjour.logger.debug "visit_step"
      step.accept(self)
      Testjour.logger.debug "visit_step done"
    end

    def visit_step_result(keyword, step_match, multiline_arg, status, exception, source_indent, background)
      Testjour.logger.debug "visit_step_result"
      ...
      Testjour.logger.debug "visit_step_result done"
    end

    def visit_step_name(keyword, step_match, status, source_indent, background) #:nodoc:
      Testjour.logger.debug "visit_step name."
    end

    def visit_multiline_arg(multiline_arg) #:nodoc:
      Testjour.logger.debug "visit_multiline_arg"
      multiline_arg.accept(self)
      Testjour.logger.debug "visit_multiline_arg done"
    end
    ...
    def visit_table_row(table_row)
      Testjour.logger.debug "visit_table_row"
      table_row.accept(self)
      Testjour.logger.debug "visit_table_row done"
    end

    def visit_table_cell(table_cell)
      Testjour.logger.debug "visit_table_cell"
      table_cell.accept(self)
      Testjour.logger.debug "visit_table_cell done"
    end
